...
import com.example.portal.certificate.KeystoreFactory;
import com.example.portal.spring.SpringResourceWrapperOpenSAMLResource;
...
public class SAMLConfig {
    ...
    private Logger log = LoggerFactory.getLogger(SAMLConfig.class);
